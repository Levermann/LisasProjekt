    ...
    <xsl:template match="/">
        <html>
            ...
            <body>
                <h1>Vorlesung:</h1>
                <h3>
                <xsl:value-of select="concat('Veranstaltungsname: ', Vorlesung/Titel)"/>
                </h3>
                <h3>
                <xsl:value-of select="concat('Semester: ', Vorlesung/Semester)"/>
                </h3>
                <h3>
                <xsl:value-of select="concat('Hochschule: ', Vorlesung/Hochschule)"/>
                </h3>
                <h3>
                <xsl:value-of select="concat('Semesterwochenstunden: ', Vorlesung/SWS)"/>
                </h3>
